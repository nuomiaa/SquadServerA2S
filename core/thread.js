...
let updateServerInfoInterval = null;
const clients = {};
const tempList = {};
const blacklist = {};
const serverInfo = {};
...
async function updateServerInfo() {
    clearInterval(updateServerInfoInterval);
    if (!info || info.status !== 3 || !info.info || !info.info.maxPlayers || info.info.maxPlayers == -1) {} else {
    ...
    updateServerInfoInterval = setInterval(updateServerInfo, 1000);
}
